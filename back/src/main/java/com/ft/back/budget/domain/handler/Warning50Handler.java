...
public class Warning50Handler extends BudgetAlertHandler {
    ...
    protected boolean shouldAlert(Budget budget, BigDecimal spent, List<AlertType> sentAlerts) {
        ...
        return usageRate.compareTo(new BigDecimal("50")) >= 0
                && !sentAlerts.contains(AlertType.WARNING_50);
    }

    @Override
    protected AlertType getAlertType() {
        return AlertType.WARNING_50;
    }
}
