...
import com.ft.back.transaction.presentation.dto.CategoryResponse;
import com.ft.back.transaction.presentation.dto.CreateCategoryRequest;
...
public class CategoryController {
    ...
    @GetMapping
    public ApiResponse<List<CategoryResponse>> findAll(@AuthenticationPrincipal Long userId) {
